...
__author__ = "Kirsten Tallner"
__version__ = "1.0.1"


## code adapted from "mf_keras_deep.py" in "Recommender System_Lu_Day4_Part2/RSDLP_Code"
...
def main():
    ...
    df, df_train, df_test, X, y, df_X_train, df_X_test, df_y_train, df_y_test = readData(groupBy=True)
