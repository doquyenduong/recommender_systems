...
## get datasets
df_train, df_test, arr_train, arr_test, test_csv_boole = readData(False)

# ## get numbers of users and songs
# no_userID_train, no_userID_test, no_songID_train, no_songID_test = getNumber(df_train, df_test)
...
# plt.show()
#
# ## one plot for everything (loss and mse)
