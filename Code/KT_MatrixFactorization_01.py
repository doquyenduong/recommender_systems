...
def recommend_songs(df_pred, userID, df_songs, df_isListened, no_recommendations=5):
    ...
    print(f"User {userID} has already listened to", user_allSongs_enriched.shape[0], "songs.")
    print(f"Recommending the highest {no_recommendations} songs not yet having listened to: ")
    ...
    return user_allSongs_enriched, df_recommendations
...
def main():
    ...
    already_rated, predictions = recommend_songs(df_pred, 79, df_songs, df_isListened, 10)
    print("\n----------------------already listened----------------------------")
    print(already_rated)
